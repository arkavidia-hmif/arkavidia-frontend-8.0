...
const Contact = ({
  ...
  return (
    <div className="flex w-full flex-col px-20 py-[5rem] bg-white relative">
      <p className="text-[64px] mb-[2rem] font-archivo capitalize">
        Contact person
      </p>
      <div className="flex flex-col md:flex-row gap-x-5 gap-y-5 items-center">
        {wa.length > 0 && (
      ...
      <div className="hidden lg:block absolute bottom-[-10px] right-10">
        <Image src={CP} />
      </div>
    </div>
  )
