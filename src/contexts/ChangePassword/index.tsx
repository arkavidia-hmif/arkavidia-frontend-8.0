        ...
        <Toast
          ...
          label={
            res == 'SUCCESS'
              ...
              : 'Gagal! Mohon cek kembali password Anda.'
          }
            ...
            <div className="w-3/4 pl-16">
              ...
              <div className="p-8 bg-white rounded-xl drop-shadow">
                ...
                <TextField
                  ...
                  width="w-full"
                />
                <p className="font-helvatica font-bold py-2">
              ...
              <div className="flex w-full pt-8 justify-end">
                <button
                  className="rounded-xl flex items-center justify-center mb-2 bg-blue300 hover:bg-blue200 hover:drop-shadow-xl active:bg-blue400 disabled:bg-gray300 disabled:opacity-50 w-auto h-12"
