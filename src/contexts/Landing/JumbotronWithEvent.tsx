...
const Jumbotron = (): JSX.Element => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'conic-gradient(90deg, #dc57af 2%, transparent 100%), linear-gradient(#FBC252 2%, transparent 100%)',
    ...
    <div
      className="
        ...
        lg:left-[100px] lg:top-[180px] lg:h-[250px] lg:w-[250px]
        xl:left-[150px] xl:top-[200px] xl:h-[300px] xl:w-[300px]"
    >
      <Image src={Image1} />
    </div>
      ...
      <div
          className="
            ...
            lg:right-[100px] lg:top-[38vh] lg:h-[250px] lg:w-[250px]
            xl:right-[150px] xl:top-[200px] xl:h-[300px] xl:w-[300px]"
        >
          <Image src={Image2} />
        </div>
      <div className="flex w-full justify-center">
        <div
          className="mr-[20px] flex flex-col w-[80px] h-[80px] items-center justify-center box bg-white rounded-lg my-[30px] pl-[5px] shadow-buttonShadow cursor-pointer active:shadow-buttonPressed active:translate-y-[4px]"
        ...
        >
          ...
          <div className="font-varela font-bold text-[13px] mt-[5px] text-center leading-tight">
            Explore Pre-Event
          </div>
        </div>
        <div
          className="ml-[20px] flex flex-col w-[80px] h-[80px] items-center justify-center box bg-white rounded-lg my-[30px] pl-[5px] shadow-buttonShadow cursor-pointer active:shadow-buttonPressed active:translate-y-[4px]"
          onClick={handleExplore}
        >
          <div className="animate-bounce mt-[10px]">
            <ArrowDownAltIcon
          ...
          <div className="font-varela font-bold text-[12px] mt-[5px] text-center leading-tight">
            Explore Main Event
          </div>
        </div>
      </div>
