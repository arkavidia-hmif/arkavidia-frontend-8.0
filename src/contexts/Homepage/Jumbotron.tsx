      ...
      <>
        <div className="bg-[#1F307C] h-[917px]">
          ...
          xl:bg-gray-200 xl:mx-[120px] xl:rounded-full xl:h-[93.25px] xl:w-auto">
            ...
            <button className="font-helvatica text-[#1F307C] my-auto
            xl:text-[16px] xl:font-black xl:ml-[740px]">
              Home
            </button>
            <button className="flex font-helvatica text-[#1F307C] my-auto
            xl:text-[16px] xl:font-black xl:ml-[81.5px]">
              Event
              <ArrowDownIcon className="my-auto
              xl:ml-[4px]"/>
            </button>
            <button className="flex font-helvatica text-[#1F307C] my-auto
          ...
          <div className="flex">
            ...
            <div className="absolute z-50 divide-y border-black
            xl:border-4 xl:mx-[410px] xl:h-[296px] xl:w-[694px] xl:mt-[184.75px]">
              <div className="flex bg-black
              xl:h-[52px]">
                <div className="rounded-full bg-[#F43518] my-auto
                xl:w-[18px] xl:h-[18px] xl:ml-[19px]">
                </div>
                <div className="rounded-full bg-[#FEB20E] my-auto
                xl:w-[18px] xl:h-[18px] xl:ml-[14px]">
                </div>
                <div className="rounded-full bg-[#069154] my-auto
                xl:w-[18px] xl:h-[18px] xl:ml-[14px]">
                </div>
              </div>
              <div className="bg-[#FFFFFF]
              xl:h-[236px]">
                <p className="text-center font-archivo text-gray-200
                xl:text-[64px] xl:mt-[20px]">
                  ARKAVIDIA 8.0
                </p>
                <div className="divide-y border-black rounded-xl mx-auto
                xl:border-4 xl:mt-[5px] xl:mx-auto xl:h-[75px] xl:w-[428px]">
                  <div className="bg-black mx-auto border-black
          ...
          ">
            <button className="divide-y-transparent bg-black border-black text-center rounded-xl hover: active: transition-all 
            xl:border-4 xl:h-[100px] xl:w-[100px]
            ">
              <div className="bg-white rounded-lg
              xl:h-[80px] xl:mb-[30px]
              ">
                <p className="font-varela font-bold
