...
const Landing = () => {
  return (
    <div>
      <div className="hidden lg:block mb-[-30px] relative">
        <div className="hidden lg:block absolute top-[-50%] right-0">
          <Image src={ArkavStamp} />
        </div>
        <svg
          fill="none"
          viewBox="0 0 1438 203"
          xmlns="http://www.w3.org/2000/svg">
          <path
            d="M1438 0C886.22 170.772 571.373 164.307 0 0V203H1438V0Z"
            fill="#FEB20E"
          />
        </svg>
      </div>
