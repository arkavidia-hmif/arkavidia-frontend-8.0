...
import Star from 'src/assets/images/404/comingsoon.svg'
...
const ComingSoon = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center text-center h-[100vh]">
            ...
            <Image src={Star} />
            <h3 className="font-archivo text-[96px] capitalize text-shadow text-red300">
            Coming Soon
            </h3>
            <p className='font-varela text-[32px] font-normal mb-[20px]'>We create great stuff for you! Stay Tuned!</p>
