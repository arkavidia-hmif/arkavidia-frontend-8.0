...
export const FAQ_ARKALOGICA = [
    ...
    },
    {
        ...
        content: "Arkalogica diadakan secara berkelompok. Satu kelompok terdiri atas dua orang yang berasal dari sekolah yang sama."
    },
    {
    ...
    },
    {
        ...
        content: "Dari semua tim yang terdaftar, akan diambil 15 tim terbaik untuk maju ke babak semifinal. 5 tim terbaik pada babak semifinal akan lolos ke babak final."
    },
    {
        title: "Bagaimana teknis perlombaan Arkalogica?",
        content: "Perlombaan terdiri dari tiga babak, yaitu babak preliminary yaitu penyisihan berupa pengerjaan soal, diikuti babak semifinal yang berupa game post-to-post, diakhiri babak final berupa soal isian dengan model penilaian seperti competitive programming."
    },
    {
        title: "Apakah kegiatan perlombaan akan diadakan secara offline?",
        content: "Babak semifinal dan final akan dilaksanakan secara offline di Institut Teknologi Bandung."
    },
]
...
export const FAQ_DATAVIDIA = [
    {
        ...
        content: "Datavida merupakan kompetisi yang bertujuan untuk menjadi ajang pengembangan kompetensi dan pertandingan antara talenta digital Indonesia khususnya di dunia sains data untuk memberikan keputusan yang bijak dan terarah."
    },
    {
    ...
    },
    {
        ...
        content: "Biaya pendaftaran untuk perlombaan Datavidia adalah Rp 90.000,- per tim."
    },
    {
        title: "Berapa orang peserta yang akan lolos ke final??",
        content: "Peserta Datavidia dinyatakan lolos ke final jika peserta termasuk 10 tim terbaik pada babak penyisihan"
    },
    {
        title: "Bagaimana teknis perlombaan Datavidia?",
        content: "Penyisihan berupa kompetisi Kaggle disertai laporan hasil pengerjaan. Final berupa makalah dari sebuah pertanyaan terbuka beserta presentasi makalah"
    },
    {
        title: "Apakah kegiatan perlombaan akan diadakan secara offline?",
        content: "Pada perlombaan Datavidia, babak penyisihan akan diadakan secara online dan babak final akan diadakan secara offline dan akan bertempat di Institut Teknologi Bandung "
    },
]
...
export const FAQ_UXVIDIA = [
    ...
    },
    {
        ...
        content: "Biaya pendaftaran untuk perlombaan UXvidia adalah Rp 90.000,- per tim."
    },
    {
        title: "Berapa orang peserta yang akan lolos ke final?",
    ...
    },
    {
        ...
        content: "Penyisihan berupa pengumpulan proposal desain UX yang dikembangkan dan video singkat penjelasan produk. Selanjutnya, pada babak final akan diadakan presentasi di depan dewan juri secara langsung."
    },
    {
        title: "Apakah kegiatan perlombaan akan diadakan secara offline?",
        content: "Pada perlombaan UXvidia, babak penyisihan akan diadakan secara online sedangkan babak final akan diadakan secara offline dan akan bertempat di Institut Teknologi Bandung "
    },
]