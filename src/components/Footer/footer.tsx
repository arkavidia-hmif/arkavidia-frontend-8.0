...
type Variants = 'yellowCompEvent' | 'redCompEvent' | 'yellowGeneral' | 'redGeneral'

type logoVar = 'square' | 'circle'

const logoStyle: { [key in logoVar]: string } = {
  circle: 'rounded-full w-[73px] h-[73px] lg:w-[124px] lg:h-[124px] ml-[24px] mt-[44px] mb-[30px] md:w-[100px] md:h-[100px]',
...
const Logo: React.FC<logoProps> = (props) => {
  ...
  return (
        <div className={`${logoStyle[logoVariants]} flex bg-white text-center justify-center border border-black `}>
...
const DummyLink = (props: any): JSX.Element => {
  return (
        <div className={`bg-gray200 border border-solid border-black mt-[2px] pt-[6px] pl-[6px] pb-[8px] font-helvatica font-normal text-[16px] leading-[18.4px] shadow-[4px_9px_0] ${props.color}`}>
            <a href=''>DUMMY LINK</a>
...
const About = (): JSX.Element => {
  return (
        <div className='flex bg-white border-black border ml-[24px] mr-[14%] shadow-[11px_10px_0] shadow-blue300 justify-center items-center'>
            <div className='py-[6.8%] px-[5%] '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis dolor repellat ut velit pariatur, illum error deserunt voluptatibus, soluta, explicabo eveniet asperiores officiis.</div>
        </div>
  )
}
...
const Copyright = (): JSX.Element => {
  return (
        <h4 className='flex flex-col font-inter px-[17px] py-[13px] gap-10 w-[100%] h-[45px] mt-0 bg-cream300 border border-solid border-black'>&copy; 2022 ARKAVIDIA. All rights reserved.</h4>
  )
}
...
const CompEventFooter: React.FC<FooterProps> = (props) => {
  ...
  const Header = <div className='grid grid-rows-2 grid-cols-11 gap-x-[3px] lg:gap-x-0 mx-[4.5%] mb-[3%] my-[3%] lg:my-[6%] lg:mb-[2%]'>
  ...
  <div className={`flex col-span-8 font-helvatica text-white ${color} text-700 text-[12px] lg:text-[16px] text-center px-[5%] border-[2px] border-black justify-center items-center lg:w-[85%]`}>ADAPTIVE COLLABORATION TO ENCOUNTER DIGITAL DISRUPTION</div>
</div>

  const Links = <div className='bg-white grid grid-cols-2 mx-[4.42%] border border-black lg:mr-0'>
    <div className='mx-[10%] grid-rows-5'>
        <div className='font-helvatica text-700 text-[16px] font-bold text-white bg-black text-center my-[4%]'>Competition</div>
        <div className='font-helvatica text-normal text-[14px] text-blue300'>
            <a className='block mb-[10px]' href=''>Competitive Programming</a>
            <a className='block mb-[10px]' href=''>Datavidia</a>
            <a className='block mb-[10px]' href=''>Arkalogica</a>
            <a className='block mb-[10px]' href=''>UXVidia</a>
        </div>
    </div>
    <div className='mr-[11%] grid-rows-6 lg:pb-[15px]'>
        <div className='font-helvatica text-700 text-[16px] font-bold text-white bg-black text-center my-[4%]'>Event</div>
        <div className='font-helvatica text-normal text-[14px] text-blue300'>
            <a className='block mb-[10px]' href=''>Arkavidia Academya</a>
            <a className='block mb-[10px]' href=''>Arkavidia For Indonesia</a>
            <a className='block mb-[10px]' href=''>Arkavidia Goes To School</a>
            <a className='block mb-[10px]' href=''>Arkavidia Talks</a>
            <a className='block mb-[10px]' href=''>IT Fest</a>
        </div>
    </div>
</div>
  ...
  return (
      <div className={variantStyle[variant]} {...rest}>
          ...
          <div className='lg:grid lg:grid-cols-2'>
            ...
            <div className='lg:row-span-2 mt-[4.8%] mb-[3.5%]'>
                {Links}
            </div>
            <div className='lg:grid lg:grid-cols-2'>
                <div className='mx-[4.42%] my-[3.7%] w-[328px] y-[47px] lg:mt-[1%] lg:mb-[4.32%] lg:mx-[9%] '>
                    <div className='flex items-stretch py-[4.5%] pl-[5%] shadow-[4.47px_4.82px_0] shadow-blue300 lg:py-[3.6%] bg-white border border-black'>
                        ...
                        <div className='inline font-helvatica text-700'>CP: Abdul (0888-8888-8888)</div>
                    </div>
                </div>
...
const GeneralFooter: React.FC<FooterProps> = (props) => {
  ...
  return (
        <>
        <div className={`h-[455px] grid grid-cols-[30%_70%] pb-[5.1%] ${variantStyle[variant]}`}>
                <div>
