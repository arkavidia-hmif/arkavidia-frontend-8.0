...
const classNames = [
  'left-[50%] absolute flex justify-center p-6 bg-black w-40 h-40 items-center drop-shadow-md rounded-md border-black border-2',
  'right-[50%] absolute flex justify-center p-6 bg-black w-40 h-40 items-center drop-shadow-md rounded-md border-black border-2',
  'bg-black w-60 h-60 drop-shadow-md rounded-md border-black border-2 relative z-10'
]
