...
const Types: Record<
  string,
  { primaryIcon: JSX.Element; clearIcon: JSX.Element; className: string }
> = {
  success: {
  ...
  warning: {
    primaryIcon: (
      <WarningIcon fill="#DF9800" className="h-6 w-6 sm:h-9 sm:w-9" />
    ),
  ...
  danger: {
    primaryIcon: (
      <WarningIcon fill="#EB4C2B" className="h-6 w-6 sm:h-9 sm:w-9" />
    ),
